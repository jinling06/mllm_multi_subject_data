...
if __name__ == '__main__':
    # 生物、地理、政治、历史  总数 325047 公示图 1592
    ...
    save_path = f'{data_dir}/train_1027_with_formula.json'
    only_image_save_path = f'{data_dir}/train_1027_with_formula_with_image.json'
