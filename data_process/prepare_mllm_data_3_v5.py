...
if __name__ == '__main__':
    # 只有 生物
    data_name = 'mllm_data_3_v5'
    data_dir = 'MLLM_data_3_v5'
    json_save_dir = f'{data_dir}/common_ratio_json_file'

    image_path_2_formular_text_path = f'{data_dir}/image_path_to_formular_text_1031.json'
    change_formular_save_path = f'{data_dir}/train_1031_science_change_formula_latex.json'
    save_path = f'{data_dir}/train_1031.json'
    only_image_save_path = f'{data_dir}/train_1031_with_image.json'
